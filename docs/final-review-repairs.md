...
- Draft owners can generate a 24-hour, one-time, session-bound LINE invite link. An invited LINE user joins as a member, then the owner can designate a deputy. The UI never asks users to type internal UUIDs.
