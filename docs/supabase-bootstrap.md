...
3. Verify that `__besafe_migrations` contains every file in `drizzle/`, including `0011_line_location_source.sql`, `0011_route_catalog_tiered_sources.sql`, `0012_guardian_invites.sql`, `0013_alert_job_heartbeat.sql`, and `0014_session_revocations.sql`.
