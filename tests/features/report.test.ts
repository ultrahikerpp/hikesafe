...
describe('buildEmergencyReport', () => {
  ...
  it('includes the required rescue details and current GPS metadata', () => {
    ...
    expect(report.text).toContain('開始時間：2026-07-12T01:00:00.000Z');
    expect(report.text).toContain('預計下山：2026-07-12T09:00:00.000Z');
    expect(report.text).toContain('最後成功回報：2026-07-12T05:10:00.000Z');
    expect(report.text).toContain('GPS 精度：12 公尺');
    expect(report.text).toContain('GPS 時間：2026-07-12T05:09:00.000Z');
